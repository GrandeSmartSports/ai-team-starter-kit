...
- You charge: **$29/month** per member (founding rate, locked forever)
- Skool takes: **$0** (they charge YOU $9/month, not a percentage)
- Stripe takes: ~2.9% + $0.30 per transaction (standard credit card processing)
- **Your net per member: ~$27.86/month**

To hit your first $100: 4 paying members.
To cover Skool's cost ($9): 1 paying member.
...
1. Go to **skool.com** in your browser
2. Click "Get Started" or "Create Account"
3. Sign up with your email (use your personal email, not work)
4. Verify your email
5. You're in the Skool dashboard

### Step 2: Create Your Community (5 minutes)
...
Categories are like channels in a Discord server. They organize your community feed.
...
3. Click "New Post"
4. Copy and paste from `launch/skool-welcome-post.md`
5. Post it
6. **Pin it** (click the three dots on the post → Pin)
...
6. In the post body, paste the start-here guide from `launch/start-here-guide.md`
7. Pin this post

### Step 7: Set Up the Course Section (5 minutes)

Skool has a "Classroom" section where you can organize lessons into modules.

1. Click the "Classroom" tab in your group
2. Create Module 1: "The Foundation"
   - Add Lesson 1: Copy from `course/module-1/lesson-1-why-one-agent-isnt-enough.md`
   - Add Lesson 2: Copy from `course/module-1/lesson-2-setting-up-your-first-team.md`
   - Add Lesson 3: Copy from `course/module-1/lesson-3-identity-anchoring.md`
   - Add Lesson 4: Copy from `course/module-1/lesson-4-your-first-build-session.md`
3. Create Module 2: "Memory Systems"
   - Add Lessons 1-3 from `course/module-2/`
4. Create Module 3: "Rules & Security"
   - Add Lessons 1-3 from `course/module-3/`
5. Create Module 4: "Scaling Your Team"
   - Add Lessons 1-3 from `course/module-4/`

**Tip:** You don't have to do all modules at once. Start with Module 1. Add the rest over the next few days. Members don't need everything on day one.
...
Your community is now live at `skool.com/ai-team-builders` (or whatever URL you chose).

Share that link. Anyone who clicks it can see the About page and join.
...
| What | Where |
|------|-------|
| Skool website | skool.com |
| Your community URL | skool.com/ai-team-builders (once created) |
| Monthly cost to you | $9/month |
| Monthly revenue per member | ~$27.86 (after Stripe fees) |
| Break even | 1 member |
| First $100 target | 4 members |
| All the copy you need | `launch/` folder in the starter kit |
| All the course content | `course/` folder in the starter kit |
