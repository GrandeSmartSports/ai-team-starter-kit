...
## Day 0: Welcome DM (Send immediately when they join)

**Send this as a direct message in Skool:**

Hey! Welcome to AI Team Builders. Glad you're here.
...
## Day 3: Check-in DM (Send 3 days after they join)
...
Also, the course is in the Classroom tab if you want to understand the theory behind how the system works. Module 1 is the best place to start.

---

## Day 7: Content Prompt (Send 1 week after they join)
...
### When someone posts a question in Help:
- Respond within 24 hours (same day if possible)
- Give a real answer, not a one-liner
...
Keep the community alive with consistent content:
...
## Content Ideas (When You Don't Know What to Post)

- Screenshot of your terminal with 4 agents working
- A bug your QA agent caught that you would have missed
- A new rule you added after an agent made a mistake
- Before/after of a feature your team built in one session
- A question a member asked that made you think
